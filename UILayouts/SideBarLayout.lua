...
return
{
    ...
    tElements =
    {
        ...
        },
		{
            ...
            onPressed =
            {
                { key = 'SquadButton', color = BRIGHT_AMBER, },
            },
            onReleased =
            {
                { key = 'SquadButton', color = AMBER, },
            },
            onHoverOn =
            {
                { key = 'SquadButton',  color=Gui.AMBER, },
                { key = 'SquadLabel', color = { 0, 0, 0 }, },
                { key = 'SquadIcon', color = { 0, 0, 0 }, },
                { key = 'SquadHotkey',  color = { 0, 0, 0 }, },
                { key = 'SquadHotkeyExpanded', color = { 0, 0, 0 }, },
                { playSfx = 'hilight', },
            },
            onHoverOff =
            {
